...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="/media/css/style.admin.css?v=1">
...
{if isset($view)}{$view}{/if}
		...
		<script src="/media/js/jquery-ui-1.8.4.min.js?v=1"></script>
		<script src="/media/js/jquery.cookie.js?v=1"></script>
		<script src="/media/js/admin.js?v=1"></script>
		<!--[if lt IE 7 ]><script src="/media/js/dd_belatedpng.js?v=1"></script><![endif]-->
	</body>
</html>
